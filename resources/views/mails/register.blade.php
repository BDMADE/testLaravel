...
<head>
    ...
    <title> success register on {!! config('app.name') !!}</title>
                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            ...
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    thank you for your registration, if you have placed an order a comfirmation email you will send.
                                                    if not place your order now and pay only 35% of the total amount of your order.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
                                        {!! config('app.name') !!}<br>
                                        &copy; {!! date('Y') !!} {!! config('app.website') !!}
                                    </td>
                                </tr>
                            </table>
                        </td>
