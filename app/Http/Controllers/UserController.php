...
class UserController extends AppBaseController
{
    ...
    function saveAndConnect(Request $request){
        ...
        return response()->json(array('statu' => 1));

    }

    function loginUser(Request $request){
        if (Auth::attempt(['email' => $request->email, 'password' => $request->pwd], $request->remember)) {
            // Authentication passed...
            return response()->json(array('statu' => 1));
        }
        return response()->json(array('statu' => 0));
    ...
    function registerUser(Request $request){
        ...
        if (!$user) {
            ...
            Mail::to($user->email)->send(new StandardMail);
    ...
    public function profile(Request $request) {
        ...
        return view('users.updateProfile')->with('menu', 2);
